# 📝 Questões para Fixação - Capítulo 5: Introdução ao SGBD MySQL
...
|                                             | MySQL Shell | mysql -u root -p | sudo systemctl start mysql | CREATE DATABASE | MySQL Workbench |
| :-----------------------------------------: | :---------: | :--------------: | :------------------------: | :-------------: | :-------------: |
|          Comando para criar banco           |             |                  |                            |                 |                 |
|          Ferramenta gráfica MySQL           |             |                  |                            |                 |                 |
|   Comando para acessar MySQL no terminal    |             |                  |                            |                 |                 |
| Comando para iniciar serviço MySQL no Linux |             |                  |                            |                 |                 |
|           Ferramenta CLI para SQL           |             |                  |                            |                 |                 |

------

## **5️⃣ Questões de Verdadeiro ou Falso**

1. "O MySQL é um SGBD proprietário e requer licença paga para uso empresarial."
      - [ ] Verdadeiro
      - [ ] Falso
2. "O comando `CREATE DATABASE` é utilizado para remover um banco de dados do MySQL."
      - [ ] Verdadeiro
      - [ ] Falso
3. "No Windows, o MySQL pode ser instalado através do MySQL Installer."
      - [ ] Verdadeiro
      - [ ] Falso
4. "O MySQL Workbench é uma ferramenta de linha de comando para gerenciar bancos de dados."
      - [ ] Verdadeiro
      - [ ] Falso
